...
@Composable
fun PokemonScreen(viewModel: PokemonViewModel = viewModel(factory = PokemonViewModel.Factory), modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        LazyVerticalGrid(
            ...
            val pokemonList = (uiState.currentState as RequestStatus.Success).pokemonList
